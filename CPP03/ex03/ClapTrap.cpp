...
/*   Updated: 2024/02/22 17:17:14 by fgonzale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : _name("DefaultClap"), _hitPoints(10), _energy(10), _attackDamage(0)
{
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (this->_hitPoints <= 0)
		std::cout << this->_name << "ClapTrap " << " is dead." << std::endl;
}
